  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f99da22c-8ef2-49f1-b6a3-df406303fe09",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "269fbe05-4e62-4c0c-ad17-35d22238c6de",
          "type": "basic.input",
          "data": {
            "name": "Interruptor",
            "pins": [
        ...
        {
          "id": "b29bd7b3-54a3-4c6b-ae04-d18ce7ac7223",
          "type": "basic.output",
          "data": {
            "name": "Motor",
            "pins": [
        ...
        {
          "id": "5efb7bd4-16a2-45da-93c4-c94202586cff",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "7feb03a0-cef2-45a8-9987-c61e59c4bd88",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "85450bf6-bad1-4189-b955-d7c32ff3065c",
          "type": "f97d11b78f83014e3f27ffb06850087e01ea5690",
          "position": {
            "x": 448,
            "y": 552
        ...
        {
          "id": "ac4386d0-be7a-4a2e-8b4b-a7e191736e90",
          "type": "basic.info",
          "data": {
            "info": "Ejercicio 4 (5 Bitpoints). Ejercicio Libre. IceBot teledirigido",
            "readonly": false
          },
          "position": {
            "x": -344,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "85450bf6-bad1-4189-b955-d7c32ff3065c",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "b29bd7b3-54a3-4c6b-ae04-d18ce7ac7223",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "269fbe05-4e62-4c0c-ad17-35d22238c6de",
            "port": "out"
          },
          "target": {
            "block": "85450bf6-bad1-4189-b955-d7c32ff3065c",
        ...
        {
          "source": {
            "block": "7feb03a0-cef2-45a8-9987-c61e59c4bd88",
            "port": "out"
          },
          "target": {
            "block": "85450bf6-bad1-4189-b955-d7c32ff3065c",
        ...
        },
        {
          ...
          "target": {
            "block": "f99da22c-8ef2-49f1-b6a3-df406303fe09",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "5efb7bd4-16a2-45da-93c4-c94202586cff",
            "port": "in"
          }
        }
      ]
