{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "54662f4f-3e5a-43f5-bbd6-b6159ac6da25",
          "type": "basic.output",
          "data": {
            "name": "Servo S90 D7",
            "pins": [
        ...
        {
          "id": "c01980ab-7de4-44c0-ba92-f77d9999c051",
          "type": "basic.input",
          "data": {
            "name": "Interruptor D1",
            "pins": [
        ...
        {
          "id": "409c31d2-d5d1-470a-ad9d-f38dabf07a72",
          "type": "basic.input",
          "data": {
            "name": "Boton D1",
            "pins": [
        ...
        {
          "id": "abffb5b0-0e46-452c-a8eb-96b099699ff6",
          "type": "basic.output",
          "data": {
            "name": "Ojo Derecho",
            "pins": [
        ...
        {
          "id": "1ac3c5e4-83bd-4369-9f2d-bcfadd7bf2e3",
          "type": "basic.output",
          "data": {
            "name": "Ojo Izquier",
            "pins": [
        ...
        {
          "id": "db811cc0-862e-4e22-9338-0436f31f2178",
        ...
        {
          "id": "e1ec8229-239a-4ac2-90b9-6e5a227c460b",
        ...
        {
          "id": "84137402-e766-44b1-8a90-83af52f9f234",
        ...
        {
          "id": "84efd152-155e-48a6-93f4-c9440b64f8c1",
          "type": "basic.info",
          "data": {
            "info": "Video 12: Interruptores y pulsadores externos\nEjercicio 1",
            "readonly": false
          },
          "position": {
            "x": 264,
      ...
      "wires": [
        {
          "source": {
            "block": "c01980ab-7de4-44c0-ba92-f77d9999c051",
            "port": "out"
          },
          "target": {
            "block": "db811cc0-862e-4e22-9338-0436f31f2178",
        ...
        },
        {
          ...
          "target": {
            "block": "54662f4f-3e5a-43f5-bbd6-b6159ac6da25",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "409c31d2-d5d1-470a-ad9d-f38dabf07a72",
            "port": "out"
          },
          "target": {
            "block": "e1ec8229-239a-4ac2-90b9-6e5a227c460b",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "84137402-e766-44b1-8a90-83af52f9f234",
        ...
        },
        {
          ...
          "target": {
            "block": "abffb5b0-0e46-452c-a8eb-96b099699ff6",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "1ac3c5e4-83bd-4369-9f2d-bcfadd7bf2e3",
            "port": "in"
          }
        }
      ]
