{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "664bbdc2-0d5d-48fd-a9be-b72ef384e934",
          "type": "basic.output",
          "data": {
            "name": "Led 01",
            "pins": [
        ...
        {
          "id": "98041766-cb29-482f-932c-2306219fc987",
          "type": "basic.input",
          "data": {
            "name": "Interruptor 1",
            "pins": [
        ...
        {
          "id": "45ca331c-a754-4cdb-8d57-609fa5939a39",
          "type": "basic.output",
          "data": {
            "name": "Motor 1",
            "pins": [
        ...
        {
          "id": "f2efc149-e391-4a64-8cef-c262094d0c96",
          "type": "basic.input",
          "data": {
            "name": "INterruptor 2",
            "pins": [
        ...
        {
          "id": "eb7b2809-53a3-4c4d-867e-f7e4db9ca422",
          "type": "basic.output",
          "data": {
            "name": "Motor 2",
            "pins": [
        ...
        {
          "id": "8b15602e-414d-4f5a-b4f4-e1a02b01de59",
          "type": "basic.output",
          "data": {
            "name": "LED 02",
            "pins": [
        ...
        {
          "id": "d949d75f-72f3-494b-bcf0-ab289cf76f52",
        ...
        {
          "id": "fdaa7930-0921-4012-8ff5-91359328635b",
          "type": "f97d11b78f83014e3f27ffb06850087e01ea5690",
          "position": {
            "x": 496,
            "y": 504
        ...
        {
          "id": "7feafa78-0868-4ffc-964d-c042350c3fc7",
      ...
      "wires": [
        {
          "source": {
            "block": "98041766-cb29-482f-932c-2306219fc987",
            "port": "out"
          },
          "target": {
            "block": "d949d75f-72f3-494b-bcf0-ab289cf76f52",
            "port": "e3e07bdb-9bb3-4afb-ace5-bcc99aecef0a"
          }
        },
        {
          "source": {
            "block": "f2efc149-e391-4a64-8cef-c262094d0c96",
            "port": "out"
          },
          "target": {
            "block": "d949d75f-72f3-494b-bcf0-ab289cf76f52",
        ...
        },
        {
          ...
          "target": {
            "block": "664bbdc2-0d5d-48fd-a9be-b72ef384e934",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "8b15602e-414d-4f5a-b4f4-e1a02b01de59",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "45ca331c-a754-4cdb-8d57-609fa5939a39",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "7feafa78-0868-4ffc-964d-c042350c3fc7",
        ...
        },
        {
          ...
          "target": {
            "block": "fdaa7930-0921-4012-8ff5-91359328635b",
            "port": "e3e07bdb-9bb3-4afb-ace5-bcc99aecef0a"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "eb7b2809-53a3-4c4d-867e-f7e4db9ca422",
            "port": "in"
          }
        }
      ]
